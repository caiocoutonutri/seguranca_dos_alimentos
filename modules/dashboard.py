...
def renderizar_dashboard(resultado, dados_visita):
    ...
    <div style="text-align:center; padding:2.5rem 2rem; margin:1rem 0;
        ...
        <p style="font-family:'Inter',sans-serif; font-size:0.75rem; color:#C5A55A !important;
                  letter-spacing:3px; text-transform:uppercase; margin:0 0 0.8rem 0;">
            Conformidade Total
        </p>
        <h2 style="font-family:'Playfair Display',Georgia,serif; color:#C5A55A !important;
                   font-size:3.5rem; font-weight:700; margin:0; line-height:1;">
            {resultado['percentual']}%
        </h2>
        <p style="font-family:'Inter',sans-serif; color:{cor} !important; font-weight:600;
        ...
        <p style="font-family:'Inter',sans-serif; color:#999 !important; font-size:0.8rem; margin:0;">
