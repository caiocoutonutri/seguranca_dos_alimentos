...
def renderizar_dashboard(resultado, dados_visita):
    ...
    <div style="text-align:center; padding:1.5rem; border-radius:12px;
                background:{cor}15; border:2px solid {cor}; margin:1rem 0;">
        <h2 style="color:{cor}; font-size:3rem; margin:0;">{emoji} {resultado['percentual']}%</h2>
        <p style="color:{cor}; font-weight:600; font-size:1.1rem; margin:0.3rem 0 0 0;">{label_cls}</p>
